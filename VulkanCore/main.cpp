...
//To access native platform functions
...
//simple helper function to load the binary data from the files
...
private:
    ...
    void createSyncObjects() {
        ...
        //Creating the semaphores and fence
    ...
    void createGraphicsPipeline() {
        ...
        // comes the pipeline layout, which is a Vulkan handle rather than a struct pointer
    ...
    //helper function  to wrap files into  a VkShaderModule
    ...
    void createSwapChain() {
        ...
        //details of the swap chain images are specified:
...
#undef max
    ...
    //looks for the best mode that is available
    ...
    void createSurface() {
        ...
        //When using GLFW you should not write the Win32 version manually. (only the one above)
        /*
...
/*
        ...
        //we don't need anything special, so we can simply define it and leave everything to VK_FALSE (ATM)
...
/*
    ...
    //requirements that we'll check if the physical device is suitable for us
    bool isDeviceSuitable(VkPhysicalDevice device) {
        ...
        // Swap chain support is sufficient for this tutorial if there is at least one supported image format and one supported presentation mode given the window surface 
       ...
       /* return indices.graphicsFamily.has_value();
        ...
        // texture compression, 64 bit floats and multi viewport rendering
        VkPhysicalDeviceFeatures deviceFeatures;
        ...
        /*
        //example, let's say we consider our application only usable for dedicated graphics cards that support geometry shaders
    ...
    void populateDebugMessengerCreateInfo(VkDebugUtilsMessengerCreateInfoEXT& createInfo) {
        ...
        //structure with details about the messenger and its callback
        createInfo = {};
    ...
    void drawFrame() {
        ...
        // make sure it is able to be recorded
    ...
    void createInstance(){
        ...
        //first have to fill in a struct with some information about our application
        ...
        //add debug extensions to the instance
    ...
    //the presentation queue that retrieve the VkQueue handle
